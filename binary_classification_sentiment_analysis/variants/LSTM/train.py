...
model = Sequential([
    ...
    Dropout(0.5),  # Add dropout after embedding
    LSTM(32, recurrent_dropout=0.5),  # Add recurrent dropout to LSTM
...
# Train the model
history = model.fit(data_train, label_train, epochs=5, batch_size=512, validation_split=0.2, callbacks=[early_stopping])
...
model.save(f'./models/sentiment_model_{filename}_16_embedding.keras')
